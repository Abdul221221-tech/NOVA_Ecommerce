          ...
          {cartItems && cartItems.length > 0 && (
            <div className="p-4 border-t bg-muted/10 space-y-4">
              <div className="flex justify-between items-center font-semibold text-lg">
                ...
                <Link href="/checkout" onClick={onClose} className="inline-flex items-center justify-center truncate rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 w-full bg-accent-primary hover:bg-accent-primary/90 text-background shadow-md h-10 px-4 py-2">
                  Checkout
                </Link>
