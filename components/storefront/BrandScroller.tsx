...
export function BrandScroller({ brands }: { brands: string[] }) {
  ...
  return (
    <div className="relative group">
      ...
      <div 
        ref={scrollRef}
        className="flex overflow-x-auto gap-3 sm:gap-4 pb-6 pt-2 px-1 snap-x snap-mandatory scrollbar-hide"
      ...
      >
        {brands.map((brand) => (
          <Link 
            ...
            className="flex items-center justify-center w-[28vw] sm:w-[200px] shrink-0 h-12 min-[400px]:h-16 sm:h-24 snap-start bg-surface-base border border-border/50 rounded-xl hover:border-accent-primary/40 hover:shadow-md transition-all group/item"
          >
